    ...
    <div className="w-[68%] p-2 pr-[56px] pt-7">
      ...
      <div className="mb-6">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-4">
          <span className="text-banner-blue inline-block whitespace-nowrap rounded-md border border-gray-800 px-2 py-1 text-[0.875rem] font-medium">
            Free to message
          </span>
          <span className="text-banner-blue inline-block border-gray-800 font-normal">
      ...
      <div className="mb-6">
        ...
        <div className="break-words text-[1rem] leading-[30px] text-[#6d737e]">
          <p>
            Welcome to our flat, which is ideally situated just a short 5-minute
            walk from the University of Sydney (USYD) and Glebe Point Road. This
            prime location ensures easy access to both the bustling
          </p>

          <p>
            Broadway shopping center and the University of Technology Sydney
            (UTS), making your daily routines and university commutes incredibly
            convenient.
          </p>
          ...
          <p>
            • Spacious Living Area: The flat features a large TV room, complete
            with a comfortable couch and a smart 50-inch TV. It&apos;s an ideal
            space for unwinding after a busy day or enjoying movie nights with
            friends.
          </p>

          <p>
            • Modern Internal Laundry: The convenience of an internal laundry is
            at your fingertips, including both a washing machine and a dryer, so
            you won&apos;t need to worry about trips to the laundromat.
          </p>

          <p>
            • Flexible Room Furnishings: The room available is currently
            furnished, but we can accommodate requests for an unfurnished option
            if that better suits your needs.
          </p>

          <p>
            • All-Inclusive Pricing: The room prices cover all utility bills,
            including unlimited NBN internet, and professional cleaning services
            for the common areas. The cleaning is managed by a professional
            business, ensuring that the shared spaces are always
            well-maintained. (provided by a business, Ceje Group P / L that
            professionally manages the property)
          </p>

          <p>
            If you&apos;re interested in this flat, please reach out with some
            information about yourself. We&apos;d be more than happy to answer
            any questions you might have or arrange a viewing at a time
            that&apos;s convenient for you. Don&apos;t miss out on this
            excellent opportunity to live in a well-located and comfortable
            flat!
          </p>

          <p>
            We manage numerous listings on Flatmates, so we can show you a few
            options.
          </p>

          <p>
            Disclaimer: Pictures used in this ad are for display purposes only
            and do not reflect the exact appearance of the room available. The
            room available is similar in appearance and size.
          </p>
        </div>
      </div>
        ...
        <div>
          <div className="inline-block w-full">
            ...
            <div className="mt-3 inline-block min-w-[50%] pr-2.5 align-middle">
              ...
              <div className="block overflow-hidden text-[1rem] leading-[1.375rem] text-[#2f3a4a]">
                <span className="font-mediu mr-3 inline-block">
          ...
          <div>
            ...
            <div className="mt-3 inline-block min-w-[50%] pr-2.5 align-middle">
              ...
              <div className="block overflow-hidden text-[1rem] leading-[1.375rem] text-[#2f3a4a]">
                ...
                <span className="block text-[0.875rem]">$540 bond</span>
              </div>
            </div>
            ...
            <div className="my-5 mt-3 inline-block min-w-[50%] pr-2.5 align-middle">
              <div className="float-left mr-2 inline-block w-[24px] text-center">
                <span className="h-[24px] w-[24px] text-center">
                  <svg width="24" height="24">
                    <g fill="#2E3A4B" fillRule="evenodd">
                      <path d="M7 23h10V1H7v22zm-1.028 0h-2.95 2.95zm-3.957 0H.5a.5.5 0 0 0 0 1h23a.5.5 0 1 0 0-1H18V.5a.5.5 0 0 0-.5-.5h-11a.5.5 0 0 0-.5.5V23H2.015z"></path>
                      <path d="M9.46 12.164a.359.359 0 0 1 0 .717.358.358 0 0 1 0-.717m0 1.717a1.36 1.36 0 0 0 0-2.717 1.36 1.36 0 0 0 0 2.717"></path>
                    </g>
                  </svg>
                </span>
              </div>
